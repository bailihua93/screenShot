    ...
    html2canvas(document.body, {
        ...
        masker.onload = function () {
            ...
            var button = `<div id="selector" style=${shotBoxStyle}>
               <button id="shotConf" style="background:transparent;border: 1px solid #x000015; color:#x000015 ">确定</button><button id="shotCanc" style="background:transparent;border: 1px solid #x000015; color:#x000015 ">取消</button>
            </div>
           `
